<div class="modal fade" tabindex="-1" id="modCosts">
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="monthForm_c">
        <nav class="row mt-3 pb-3 mx-2 g-0">
          ...
          <div class="position-relative mb-3 mt-3 pt-1 pb-1">
            <div class="col-7 position-absolute top-0 end-0">
              <select
                ...
                name="filter"
              >
                <option value="1">Всі витрати авто</option>
                <option value="2">Заправка</option>
                <option value="3">Інші витрати авто</option>
                <option value="4">Особисті витрати</option>
              </select>
            </div>
            <div id="modalBody_c"><!-- get api --></div>
          </div>
        </main>
      </form>
    </div>
